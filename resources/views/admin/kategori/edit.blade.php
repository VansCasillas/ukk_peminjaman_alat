...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST" class="bg-white p-4 rounded shadow-sm">
        @csrf
        @method('PUT')

        <div class="mb-3">
            <label for="name" class="form-label fw-semibold text-dark">Nama Kategori</label>
            <input type="text" id="name" name="nama_kategori" class="form-control styled-input" value="{{ old('nama_kategori', $kategori->nama_kategori) }}" required>
