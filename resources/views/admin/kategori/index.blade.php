                ...
                <table class="table align-items-center mb-0" id="siswa">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle text-left text-sm">{{ $ktr->nama_kategori }}</td>
                            <td class="text-center align-middle">
                                <div class="d-flex justify-content-center gap-2">
                                    <a style="position: relative; top: 7px;" href="{{ route('admin.kategori.edit', $ktr->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <form action="{{ route('admin.kategori.destroy', $ktr->id) }}" method="post" onsubmit="return confirm('Yakin ingin menghapus kategori ini?')">
                                        @csrf
                                        @method('DELETE')
