...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.petugas.store') }}" method="POST" class="bg-white p-4 rounded shadow-sm">
        @csrf

        <div class="mb-3">
            <label for="name" class="form-label fw-semibold text-dark">Nama Petugas</label>
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('admin.petugas.index') }}" class="btn btn-outline-secondary px-4 ms-2">Kembali</a>
        </div>
    </form>
</div>
