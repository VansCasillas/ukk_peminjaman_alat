    ...
    <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Pengembalian Alat</h6>
            </div>
        </div>
        <div class="m-3 mb-2">
            @if(session('success'))
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <div class="d-flex justify-content-center gap-2">
                                    <form action="{{ route('peminjam.pengembalian.update', $pemalt->id) }}" method="post" onsubmit="return confirm('Yakin ingin mengembalikan peminjaman ini?')">
                                        @csrf
                                        @method('PUT')
                                        <button style="position: relative; top: 7px;" type="submit" class="btn btn-danger btn-sm">Kembalikan</button>
                                    </form>
                                </div>
                                @endif
                            </td>
